    ...
    async function fetchPosts(language) {
        ...
        const posts = {
            english: [
                ...
                { id: 3, title: 'How to learn English effectively.', author: 'User3' },
                { id: 4, title: 'English board announcements.', author: 'Admin' },
                { id: 5, title: 'Join our English study group.', author: 'User4' }
            ],
            japanese: [
                { id: 1, title: 'こんにちは、日本語の掲示板です。', author: 'User1' },
                { id: 2, title: '日本語の掲示板へようこそ。', author: 'User2' },
                { id: 3, title: '効果的に日本語を学ぶ方法。', author: 'User3' },
                { id: 4, title: '日本語掲示板の通知。', author: 'Admin' },
                { id: 5, title: '日本語の勉強会に参加しよう。', author: 'User4' }
            ],
            chinese: [
                { id: 1, title: '你好，这是一个中文公告板。', author: 'User1' },
                { id: 2, title: '欢迎来到中文公告板。', author: 'User2' },
                { id: 3, title: '如何有效地学习中文。', author: 'User3' },
                { id: 4, title: '中文公告板公告。', author: 'Admin' },
                { id: 5, title: '加入我们的中文学习小组。', author: 'User4' }
            ],
            spanish: [
                ...
                { id: 3, title: 'Cómo aprender español efectivamente.', author: 'User3' },
                { id: 4, title: 'Anuncios del tablero de español.', author: 'Admin' },
                { id: 5, title: 'Únete a nuestro grupo de estudio de español.', author: 'User4' }
            ]
        };
